...
## 1st potential bug: lucky pick feature, cannot select a song from the "mixed" playlist

line 190 in playlist_logic.py. add "playlists.get("Mixed", [])" in the else statement to include songs in the mixed playlist.

## 2nd potential bug: hype ratio doesn't change when i move the hype energy levels, always 1.0
...
## 3rd potential bug: only complete name of artist returns the song. ex) putting weeknd won't show up unless you put "the" weeknd
